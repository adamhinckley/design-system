...
This package requires Tailwind CSS to be installed and configured in your project. If you haven't already set up Tailwind CSS:
...
Then add the design system styles to your `tailwind.config.ts`:
...
export default {
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
    "node_modules/@adamhinckley/design-system/dist/**/*.{js,mjs}",
  ],
  theme: {
    extend: {},
  },
...
```tsx
import { TextField } from "@adamhinckley/design-system";
import type { InputProps } from "@adamhinckley/design-system";
